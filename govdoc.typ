...
#let letter(
  ...
  // ปรับเพิ่มช่องว่างก่อนคำลงท้าย ให้เว้นห่างลงมาอีก 1 บรรทัด (1 Enter + Before 12pt)[cite: 5]
  v(24pt)

  // 6. คำลงท้าย และ ลายมือชื่อ
  // วางคำลงท้ายเริ่มที่ 8.0cm
  place(dx: 8.0cm)[#signoff]
  v(16pt)
  v(2.0cm) // พื้นที่ 4 Enter สำหรับลงลายมือชื่อ[cite: 5]

  // จัดกึ่งกลางชื่อและตำแหน่งเทียบกับแนวคำลงท้าย
  place(dx: 2.8cm)[
