...
#let letter(
  ...
  // 6. คำลงท้าย และ ลายมือชื่อ (จัดกึ่งกลางซึ่งกันและกันอย่างแท้จริง)
  // คำลงท้ายเริ่มที่ 8.0cm
  place(dx: 8.0cm)[#signoff]
  v(16pt) // ชดเชยบรรทัดคำลงท้าย
  v(2.0cm) // พื้นที่ 4 Enter สำหรับลงลายมือชื่อ[cite: 5]

  // จุดกึ่งกลางคำลงท้ายอยู่ที่ 8.0cm + 1.8cm = 9.8cm
  // วางกล่องกว้าง 14cm โดยให้กึ่งกลางกล่อง (7cm) ตรงกับแนว 9.8cm พอดี (dx = 9.8 - 7 = 2.8cm)
  place(dx: 2.8cm)[
    #box(width: 14.0cm, align(center)[
      #signer_name \
      #v(2pt)
      #signer_pos
    ])
  ]
  v(3.0em) // พื้นที่ความสูงของกลุ่มชื่อและตำแหน่ง
