...
#let letter(
  ...
  // เลื่อนตำแหน่งบรรทัดขึ้นไปอีก 2 บรรทัด
  v(-1.85cm)
  ...
  // 3. วัน เดือน ปี (เคาะเลื่อนไปทางขวาอีก 5 เคาะ -> 8.7cm)
  grid(
    columns: (8.7cm, 1fr),
    [],
  ...
  // 6. คำลงท้าย และ ลายมือชื่อ (เคาะเลื่อนไปทางขวาอีก 5 เคาะ ให้ตรงแนวเดียวกับวันที่ -> 8.7cm)
  grid(
    columns: (8.7cm, 1fr),
    [],
    [
